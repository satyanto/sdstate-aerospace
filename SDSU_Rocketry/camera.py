...
with picamera.PiCamera() as camera: #setting up camera
        ...
        camera.start_recording("/home/pi/Development/sdstate-aerospace/SDSU_Rocketry/videos/"+filename+".h264") #start recording
        sleep(20) # time of video in seconds
        camera.stop_recording() #recording stopped
convert = "MP4Box -add /home/pi/Development/sdstate-aerospace/SDSU_Rocketry/videos/"+filename+".h264 /home/pi/Development/sdstate-aerospace/SDSU_Rocketry/videos/"+filename+".mp4"
